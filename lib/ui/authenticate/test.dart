...
//   final reg_namecontroller = TextEditingController();
//   final reg_emailController=TextEditingController();
//
//
//   bool loading = false;
//   String password = '';
...
//                                         loading= true;
//                                       });
//                                       dynamic result = await _auth.signInWithEmailAndPass(username_controller.text.trim(), password_controller.text);
//
//                                       if(result== null){
//                                         setState((){
//                                           loading = false;
...
//                                               .registerWithEmailAndPass(reg_namecontroller.text,
//                                               reg_emailController.text, password);
//                                           if (result ==null) {
//                                             setState(() {
//                                               loading = false;
//
